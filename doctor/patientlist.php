...
<html lang="en">
    <head>
        ...
        <title>Bienvenido <?php echo $userRow['doctorFirstName'];?> <?php echo $userRow['doctorLastName'];?></title>
        <!-- Bootstrap Core CSS -->
                ...
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="doctorprofile.php"><i class="fa fa-fw fa-user"></i> Perfil</a>
                            </li>
                           
                            <li class="divider"></li>
                            <li>
                                <a href="logout.php?logout"><i class="fa fa-fw fa-power-off"></i> Cerrar sesion</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-calendar"></i> Lista de Pacientes
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Numero de Telefono" disabled></th>
                                    <!-- <th><input type="text" class="form-control" placeholder="Email" disabled></th> -->
                                    <th><input type="text" class="form-control" placeholder="Genero" disabled></th>
...
var info = 'ic=' + ic;
if(confirm("Estas seguro que quieres borrar a este paciente?"))
{
 $.ajax({
   type: "POST",
