                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-calendar"></i> Todas mis citas
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <h3 class="panel-title">Historial de citas</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Final" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Estado" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Completada" disabled></th>
