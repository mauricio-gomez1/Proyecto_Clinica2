	...
	<body>
						...
						echo "<div class='row'>";
							echo "<div class='col-lg-12'>";
								echo "<div class='alert alert-danger alert-dismissable'>";
									...
									echo " <i class='fa fa-info-circle'></i>  <strong>Porfavor complete su perfil</strong>" ;
								echo "  </div>";
							echo "</div>";
							// <!-- notification end -->
							...
							?>
							<!-- notification end -->
							<h2>Hola <?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName'];?>. Agenda tu cita hoy!</h2>
		...
		<div class="copyright-bar bg-black">
			<div class="container">
				...
				<p class="pull-right small">Made with <i class="fa fa-heart pomegranate"></i></p>
			</div>
		</div>
		<!-- footer end -->
