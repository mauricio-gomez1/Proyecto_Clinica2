						...
						<div class="col-md-3 col-sm-3">
							...
							<div class="user-wrapper">
								...
								<div class="description">
									...
									<p>
										Ya esta en el ultimo paso para agendar su cita. Por favor, rellene el formulario de la derecha para completar su cita.
									</p>
									<hr />
										...
										<form class="form" role="form" method="POST" accept-charset="UTF-8">
											<div class="panel panel-default">
												...
												<div class="panel-body">
													...
													Direccion: <?php echo $userRow['patientAddress'] ?>
												</div>
											</div>
											<div class="panel panel-default">
												<div class="panel-heading">Informacion de la cita</div>
												<div class="panel-body">
													Dia: <?php echo $userRow['scheduleDay'] ?><br>
